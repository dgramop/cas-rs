...
pub static ONE: Lazy<Expr> = Lazy::new(|| Expr::Primary(Primary::i64(int(1))));
...
pub static ZERO: Lazy<Expr> = Lazy::new(|| Expr::Primary(Primary::i64(int(0))));
...
pub mod input {
    ...
    pub static ONE_TWELFTH: Lazy<Expr> = Lazy::new(|| make_fraction(
        Expr::Primary(Primary::i64(int(1))),
        Expr::Primary(Primary::i64(int(12))),
    ));
    ...
    pub static SEVEN_TWELFTHS: Lazy<Expr> = Lazy::new(|| make_fraction(
        Expr::Primary(Primary::i64(int(7))),
        Expr::Primary(Primary::i64(int(12))),
    ));
...
pub mod output {
    ...
    pub static SQRT_TWO_HALF: Lazy<Expr> = Lazy::new(|| make_fraction(
        Expr::Primary(Primary::i64(int(2))).sqrt(),
        Expr::Primary(Primary::i64(int(2))),
    ));

    /// sqrt(3)/2
    pub static SQRT_THREE_HALF: Lazy<Expr> = Lazy::new(|| make_fraction(
        Expr::Primary(Primary::i64(int(3))).sqrt(),
        Expr::Primary(Primary::i64(int(2))),
    ));
    ...
    /// sqrt(3)
    pub static SQRT_THREE: Lazy<Expr> = Lazy::new(|| Expr::Primary(Primary::i64(int(3))).sqrt());
}
